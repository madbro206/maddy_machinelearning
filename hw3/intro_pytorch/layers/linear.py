...
class LinearLayer(nn.Module):
    ...
    def __init__(
        ...
        self.weight = torch.randn(dim_in, dim_out, dtype=torch.float, generator=generator)
        self.bias = torch.randn(dim_out, dtype=torch.float, generator=generator)
        
        #for "optimizer to work properly"
