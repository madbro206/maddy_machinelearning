...
def vanilla_solution(x: Vector, y: Vector, A: Matrix, B: Matrix) -> Vector:
    ...
    #it took me a while to figure out I can't just add the vectors straight up :/
    #calculate Ax+A^Tx
    sum_1=[a + b for a, b in zip(Ax, ATx)]
    
    #add this result to B^Ty
    sum_2=[a + b for a, b in zip(sum_1, BTy)]
